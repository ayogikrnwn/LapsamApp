  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
                ...
                <Image source={ICLapsam} />
                 ...
                 <View style={{justifyContent: 'center', alignItems: 'center', flex: 1, paddingHorizontal: 20, marginTop: -80}}>
                 <View>
                    <Text style={{color: 'black', fontWeight: 'bold', marginBottom: 14}}>Login Sebagai</Text>
                    <DropDownPicker
