...
const MyTabsPetugas = () => {
  return (
    <Tab.Navigator tabBar={props => <MyTabBarPetugas {...props} />} screenOptions={{ headerShown: false }}>
...
const MyTabsIuran = () => {
  return (
    <Tab.Navigator tabBar={props => <MyTabBarIuran {...props} />} screenOptions={{ headerShown: false }}>
