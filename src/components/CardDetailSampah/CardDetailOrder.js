...
const CardDetailOrder = ({imgLeft, imgCenter, imgRight, status, onPress}) => {
  return (
    <View style={{backgroundColor: 'white', width: '90  %', height: 220, borderRadius: 14, paddingHorizontal: 14, paddingVertical: 10, marginBottom: 10}}>
    ...
    <Text style={{fontWeight: 'bold', color: 'black', fontSize: 18, marginTop: 8}}>1 Kantong Plastik Kecil</Text>
      ...
      <Text style={{ fontWeight: '200', color: 'red', fontSize: 14, marginTop: 8}}>Belum Diangkut</Text>
   ...
   <ButtonPrimary title="Angkut" onPress={onPress}/>
    ...
    <Text style={{fontWeight: '200', color: 'black', fontWeight: 'bold', fontSize: 12, marginTop: 8, color:'black', textAlign: 'center'}}>Lihat Foto</Text>
    </View>
      </View>
