  ...
  return (
    ...
    <View style={{flex: 1, marginTop: 30, marginRight: -30, justifyContent: 'center'}}>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
        ...
        <View>
        <Text style={{fontSize: 14, fontWeight: 'bold', color: 'black', }}>Hi, User</Text>
        <Text style={{fontSize: 14, color: 'grey'}}>Selamat Siang</Text>
        <View style={{flexDirection: 'row'}}>
        <Text style={{fontSize: 14, fontWeight: 'bold', color: 'black'}}>Poin</Text>
        <Text style={{fontSize: 14, fontWeight: 'bold', color: 'black'}}> 999+</Text>
