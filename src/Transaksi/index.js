  ...
  return (
    <View>
      ...
      <View style={{ paddingHorizontal: 16, paddingVertical: 10 }}>
        <Text style={{ fontSize: 20, color: "#155E9F", fontWeight: "bold" }}>
          Pilih Kursi
        </Text>
        <Text style={{ fontSize: 14, color: "#155E9F" }}>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <View style={{ flexDirection: "row", justifyContent: "center" }}>
            <View style={{ marginTop: 16 }}>
              <Text
                style={{ fontSize: 16, color: "#155E9F", fontWeight: "bold" }}
              >
                Harga Tiket
              </Text>
              <Text
            ...
            <View style={{ marginTop: 16, marginLeft: 60 }}>
              ...
              <Text style={{ fontSize: 16, color: "#155E9F" }}>
                Rp 1.200.000
              </Text>
            </View>
          </View>
