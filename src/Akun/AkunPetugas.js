  ...
  return (
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <ScrollView >
        ...
        <Image source={ILFoto} />
        <Text style={{fontSize: 16, color: 'black', fontWeight: 'bold'}}>Petugas</Text>
       ...
       <TouchableOpacity onPress={() => navigation.navigate('UbahProfilePetugas')} style={{backgroundColor: 'white', width: '80%', height: 50, borderRadius: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10}}>
         <Image source={ICEdit}  />
         <Text style={{fontSize: 14, color: 'black', fontWeight: '300', marginLeft: 20}}> Informasi Data Diri </Text>
        </TouchableOpacity>
